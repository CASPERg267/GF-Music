...
module.exports.load = async client => {
  ...
  setInterval(() => updateFeeds(client, feeds, global), Number(client.config.dashboard.updateFeeds) * 1000);
    ...
    const Dashboard = new DBD.Dashboard({
        ...
        redirectUri: `${client.config.dashboard.domain}${client.config.dashboard.redirectUri}`,
    ...
    underMaintenance: {
      ...
      texts: [
        ...
        theme: SoftUI({
            ...
            icons: {
                favicon: client.config.dashboard.imageFavicon,
                noGuildIcon: client.config.dashboard.iconURL,
                sidebar: {
